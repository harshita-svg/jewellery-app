...
const CompleteLook = () => {
  ...
  const completeLookProducts = products.filter(
    (p) => p.type === "complete-look"
  );

  let filteredProducts = [...completeLookProducts];
  ...
  return (
    <div className="min-h-screen px-4 py-10 bg-gradient-to-br from-fuchsia-50 via-indigo-50 to-purple-50">
      {/* Title */}
      <h2 className="text-4xl font-bold text-purple-700 mb-10 text-center flex items-center justify-center gap-3">
        <GiStarsStack className="text-5xl text-purple-500" />
        Complete Looks
      </h2>
